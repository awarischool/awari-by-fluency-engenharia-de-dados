...
path = '/home/awari/app/aula-ingestao/ingest/streaming/usuarios.csv'
...
try:
    ...
    if e.response['Error']['Code'] == "NoSuchKey":
        # Se Key não existir.
        status_df = pd.read_csv("/home/awari/app/aula-ingestao/scripts/diferencial_usuarios_em_branco.csv")
